...
![mobi.Resource summary page](/img/resource/resource-ss-summary-page.png)
This is the summary page for mobi.Resource.


## Level and Branches

![View your levels and branches](/img/resource/resource-ss-levels-branches.png)
...
![Dig into your company hierarchy](/img/resource/resource-ss-levels-view.png)


## POIs

![View your POI list](/img/resource/resource-ss-poi-tab.png)
...
![Create a new POI in mobi.Resource](/img/resource/resource-ss-add-poi-button.png)

To manually create a POI, click the **Add+** tab at the top of the POI list.

![Adding a new POI](/img/resource/resource-ss-add-poi-modal.png)
...
![POI Gefences](/img/resource/resource-ss-poi-geofence-radius.png)
...
![POI list view](/img/resource/resource-ss-poi-list-view.png)

You can edit any POIs already created by clicking on the name of the POI from the list view.

## Cost models
  
![Cost models](/img/resource/resource-ss-cost-models.png)
...
![Revenue models](/img/resource/resource-ss-revenue-models.png)
...
![Driver cost models](/img/resource/resource-ss-add-driver-cost-model.png)
...
![Add a driver cost model to a driver](/img/resource/resource-ss-give-driver-cost-model.png)
...
![Vehicle cost models](/img/resource/resource-ss-vehicle-cost-model.png)
...
![Add a vehicle cost model to a vehicle](/img/resource/resource-ss-vehicle-gets-cost-model.png)
...
![Vehicles in mobi.Resource](/img/resource/resource-ss-vehicles.png)

The Vehicle’s tab will let you **view**, **edit**, or **add to a list** of all your vehicles. 

![Edit vehicles in mobi.Resource](/img/resource/resource-ss-vehicle-edit-modal.png)
...
![Drivers in mobi.Resource](/img/resource/resource-ss-drivers.png)

The Driver tab will let you edit existing drivers or add new drivers. 

![Edit drivers](/img/resource/resource-ss-edit-existing-driver.png)
...
![Add a new driver in mobi.Resource](/img/resource/resource-ss-add-new-driver.png)
...
![Maintenance reminders](/img/resource/resource-ss-maintenance-reminders.png)
...
![Add a maintenance reminder](/img/resource/resource-ss-add-maintenance-reminder.png)
...
![Schedule reports](/img/resource/resource-ss-scheduled-reports.png)
...
![Edit or delete a scheduled report](/img/resource/resource-ss-edit-scheduled-report.png)
...
![Alert configurations](/img/resource/resource-ss-alert-configurations.png)
...
![Add a new alert](/img/resource/resource-ss-add-alert.png)
...
![Add a 10 digit phone number for SMS alerts](/img/resource/resource-ss-sms-setup.png)
