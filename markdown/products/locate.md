...
![mobi.Locate summary view]({{ site.baseurl }}/img/locate/locate-ss-summary.jpg)
...
![mobi.Locate tabs]({{ site.baseurl }}/img/locate/locate-ss-tabs.jpg)
...
![mobi.Locate map]({{ site.baseurl }}/img/locate/locate-ss-map-branch.jpg)
...
![mobi.Locate driver location]({{ site.baseurl }}/img/locate/locate-ss-map-driver.jpg)
...
![mobi.Locate driver search]({{ site.baseurl }}/img/locate/locate-ss-driver-search.jpg)
...
![mobi.Locate traffic view]({{ site.baseurl }}/img/locate/locate-ss-traffic.jpg)
...
![mobi.Locate satellite view]({{ site.baseurl }}/img/locate/locate-ss-satellite.jpg)

To change the view of the map, click the **Map** or **Satellite** tabs at the top right of the map.

### Street view

![mobi.Locate streetview]({{ site.baseurl }}/img/locate/locate-ss-streetview.jpg)
...
![mobi.Locate find closest driver by address]({{ site.baseurl }}/img/locate/locate-ss-find-address.jpg)

**Find Closest Driver By Address** will find which of your drivers is closest to a particular address.

## Scorecard

![mobi.Locate driver scorecard trips]({{ site.baseurl }}/img/locate/locate-ss-scorecard-trips.jpg)

**Scorecard** is a history of trips the driver has already completed.

![mobi.Locate driver scorecard trips]({{ site.baseurl }}/img/locate/locate-ss-scorecard-link.jpg)
...
![mobi.Locate start POI]({{ site.baseurl }}/img/locate/locate-ss-scorecard-start.jpg)
...
![mobi.Locate driver gps waypoints]({{ site.baseurl }}/img/locate/locate-ss-gps-waypoints.jpg)
...
![mobi.Locate scorecard schedule board]({{ site.baseurl }}/img/locate/locate-ss-schedule-board-chart.jpg)
...
![mobi.Locate reports]({{ site.baseurl }}/img/locate/locate-ss-reports.jpg)

To view reports in mobi.Locate, click the **Reports** tab at the top right of the screen.

## Visit reports

![mobi.Locate visit report]({{ site.baseurl }}/img/locate/locate-ss-visit-report.jpg)
...
![mobi.Locate visit report driver]({{ site.baseurl }}/img/locate/locate-ss-visit-report-driver.jpg)

Clicking a driver name will give you a detailed list of each trip visit made by that driver for the set date range.

![mobi.Locate visit report driver]({{ site.baseurl }}/img/locate/locate-ss-visit-report-filter.jpg)
...
![mobi.Locate report exports]({{ site.baseurl }}/img/locate/locate-ss-exports.jpg)
...
![mobi.Locate schedule reports]({{ site.baseurl }}/img/locate/locate-ss-schedule-report.jpg)
...
![mobi.Locate safety reports]({{ site.baseurl }}/img/locate/locate-ss-safety.jpg)

To view **safety exceptions**, click the **Safety** tab in the left side menu.

![mobi.Locate safety reports]({{ site.baseurl }}/img/locate/locate-ss-safety-filter.jpg)

To filter which speeding instance you see, click the **Filter** button at the top.

![mobi.Locate safety reports]({{ site.baseurl }}/img/locate/locate-ss-safety-speed-link.jpg)
...
![mobi.Locate safety reports]({{ site.baseurl }}/img/locate/locate-ss-safety-speeding.jpg)
...
![mobi.Locate compliance report]({{ site.baseurl }}/img/locate/locate-ss-compliance.jpg)
...
![mobi.Locate maintenance reminders]({{ site.baseurl }}/img/locate/locate-ss-maintenance.jpg)
...
![mobi.Locate location report]({{ site.baseurl }}/img/locate/locate-ss-location-report.jpg)
